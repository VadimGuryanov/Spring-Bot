...
@Configuration
@EnableJpaRepositories(basePackages = {"ru.kpfu.itis.springbots.repository"})
@ComponentScan(basePackages = {"ru.kpfu.itis.springbots"})
...
public class RootConfig{
    ...
    private Properties getHibernateProperties() {
        ...
        properties.put("hibernate.dialect", SQLiteDialect.class);
